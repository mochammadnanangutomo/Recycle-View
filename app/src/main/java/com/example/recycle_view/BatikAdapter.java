...
public class BatikAdapter extends RecyclerView.Adapter<BatikAdapter.BatikViewHolder>{
    ...
    int images[];
    Context context;
    public BatikAdapter(Context ct, String s1[], String s2[],
                          String s3[], int img[]){
        context = ct;
        data1 = s1;
        data2 = s2;
    ...
    @NonNull
    @Override
    public BatikAdapter.BatikViewHolder
    onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        LayoutInflater layoutInflater =
                LayoutInflater.from(parent.getContext());
        View view = layoutInflater.inflate(R.layout.item_batik,
                parent, false);
        return new BatikViewHolder(view);
    }
    @Override
    public void onBindViewHolder(@NonNull BatikAdapter.BatikViewHolder holder, int position) {
